...
#    m.pset('vectorfrequency', 390625) #12.5e6)
    ...
    scan_all_mea_pH_single_pixel = m.Generate_scan_vector_mea_pH_single_pixel(25,25)
...
#    plt.show() 
    ...
    with open('ph5_sweep.npy', 'wb') as f:
        np.save(f, adcdata)
...
#    plt.figure(figsize=(8,12))
#    plt.imshow(image_2d_ph1, vmax=-0.15, vmin=-0.25)

...
#    m.pset('vectorfrequency', 390625) #12.5e6)
    ...
    scan_all_reset_deselect = minerva.Generate_scan_vector_rst_deselect()
    scan_all_mea_impedance = minerva.Generate_scan_vector_mea_ECT()
    ...
    for col_addr in range(256):   
        ...
        m.SendScanVector(scan_all_set_sensing_mode)  # send as 32 bit vector
        time.sleep(0.02)
    print('')
    ...
    #m.SendScanVector_4bit(scan_all_reset)
    #time.sleep(0.1)
    #m.SendScanVector_4bit(scan_all_reset_deselect)
    #time.sleep(0.1)
...
#        np.save(f, image_2d_ph2)
    ...
    fname = 'X:\EmbeddedBioelectronics\projects\Minerva\data\D0001_yeast\yeast_4.h5'
    grp_name = 'impedance'

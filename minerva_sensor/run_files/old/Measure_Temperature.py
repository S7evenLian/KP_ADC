...
#    
    ...
    with open('data/temperature/image_ph1_T'+str(T)+'_VCM'+str(VCM)+'.npy','wb') as f:
        np.save(f, image_2d_ph1)

    with open('data/temperature/image_ph2_T'+str(T)+'_VCM'+str(VCM)+'.npy','wb') as f:
